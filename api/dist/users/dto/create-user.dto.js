...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Informe o nome' }),
    (0, class_validator_1.MinLength)(2, { message: 'O nome deve ter pelo menos 2 caracteres' }),
    (0, class_validator_1.MaxLength)(40, { message: 'O nome é longo demais' }),
...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(150, { message: 'E-mail longo demais' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(20, { message: 'A senha é longa demais' }),
    __metadata("design:type", String)
